...
- **Main task page** — empty task list with the default view showing incomplete tasks.
- **Inbox** — empty and ready for capture ([F4](./f4-inbox.mdx)).
...
A fuller install adds starter [custom fields](./f2-custom-fields.mdx) and [views](./f5-views.mdx).
