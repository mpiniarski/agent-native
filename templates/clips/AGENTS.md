...
| Action               | Args                                                                                                                                                                             | Purpose                                                                                                                                               |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| `create-recording`   | `[--title] [--titleSource default\|context\|upload\|ai\|manual] [--sourceAppName] [--sourceWindowTitle] [--folderId] [--spaceIds] [--organizationId] [--hasCamera] [--hasAudio]` | Insert a recording row in `uploading` status. Called from the frontend upload flow; recorders pass app/window context for Loom-style fallback titles. |
