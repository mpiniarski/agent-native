...
## Internal Architecture & Runbook (moved from public docs)

This section captures internal runbook, ops, and roadmap detail that used to live
in the public `template-brain.md` overview. It is reference material for the
agent and maintainers; it is intentionally not in the public docs.
